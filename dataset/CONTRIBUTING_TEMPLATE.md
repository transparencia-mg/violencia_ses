...
A documentação deste conjunto de dados está sendo feita de forma aberta e colaborativa no [Github](https://github.com/{{ owner_repo }}). Existem duas alternativas para enviar sua contribuição:

- [Issues](https://github.com/{{ owner_repo }}/issues): Para iniciar uma discussão sobre melhorias na documentação.
- [Pull requests](https://github.com/{{ owner_repo }}/pulls): Para sugerir uma alteração concreta na documentação.
